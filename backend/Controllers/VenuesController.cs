...
public class VenuesController : ControllerBase
{
    ...
    private static VenueDto ToDto(Venue v) => new(v.Id, v.Name, v.City, v.Capacity, v.Lives.Count);
    ...
    {
        var v = new Venue { Name = input.Name, City = input.City, Capacity = input.Capacity };
        _db.Venues.Add(v);
